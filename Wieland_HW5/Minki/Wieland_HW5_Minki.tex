...
\begin{enumerate}[label = (\alph*)]
	...
	\begin{align*}
	\frac{d Y}{d G} &=  1 + \frac{\frac{\kappa}{\eta \phi} \rho(1-s_g)}{(1-\beta \rho)(1-\rho) - \frac{\kappa}{\psi} \left[ \psi + \frac{1}{\eta} (1-s_g) \right]} \\
	& > 1
	\end{align*}
	...
	\item Assuming $\phi_\pi = 0$, or generally any value of $\phi_\pi$ which violate the Taylor principle ($\phi_\pi >1$) is problematic because the model becomes explosive. 
	\item 
	\item 
	\item 
	\item 
