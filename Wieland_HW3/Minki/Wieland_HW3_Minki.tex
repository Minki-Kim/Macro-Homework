...
\begin{enumerate}[label = (\alph*)]
	...
	\end{equation*}
	The rental rate of captial is a function of $U$ because the depreciation rate and the marginal product of capital depend on $U$. It is also a function of $q$ because replacing capital is costly, so optimizing requires taking into account just how far the firm is from equalizing replacement cost and marginal value for capital.
...
\item The log-linearized system of equations is
\begin{align*}
...
\item The multiplier is about 1.13. The new impulse response is shown in Figure \ref{5c}.
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=\textwidth]{IRF_c_plot.pdf}
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=\textwidth]{IRF_d_plot.pdf}
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=\textwidth]{IRF_d_Y_plot.pdf}
