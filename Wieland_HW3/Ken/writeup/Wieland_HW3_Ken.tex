...
\begin{enumerate}[label = (\alph*)]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{../output/IRF_b_plot.pdf}
		\caption{IRFs with $\rho = 0.9$}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{../output/IRF_c_plot.pdf}
		\caption{IRF for level of Y with $\rho = 0.9$}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{../output/IRF_d_plot.pdf}
		\caption{IRFs with $\rho = 1$}
	\end{figure}

	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{../output/IRF_d_y_plot.pdf}
		\caption{IRF for level of Y with $\rho = 1$}
	\end{figure}
